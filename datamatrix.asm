...
; public interface:
DataMatrix_code	equ $62f0	
DataMatrix_data	equ $5b90	;bank3 za maską spy
DataMatrix_SIZE	equ 24		;rozmiar

DataMatrix_EOF	equ	255

DataMatrix_message	equ	DataMatrix_data ; DataMatrix_DATA_CODEWORDS
DataMatrix_symbol	equ	DataMatrix_data+$100	; DataMatrix_SIZE*DataMatrix_SIZE
